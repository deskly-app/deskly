            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="p-3 rounded-md bg-muted/5 border border-border/10 space-y-1.5">
                  <span className="inline-flex items-center text-xs font-bold text-primary tracking-wider uppercase bg-primary/10 px-2 py-0.5 rounded-full w-fit">
                  ...
                  <div className="flex flex-col gap-1.5 mt-2 text-xs text-muted-foreground">
                    <div className="flex items-start gap-1.5">
                      <Clock className="w-3.5 h-3.5 text-muted-foreground/60 shrink-0 mt-0.5" />
                      <span className="break-words">{entry.examTime} (Reporting: {entry.reportingTime})</span>
                    </div>
                    <div className="flex items-start gap-1.5">
                      <MapPin className="w-3.5 h-3.5 text-muted-foreground/60 shrink-0 mt-0.5" />
                      <span className="break-words">{entry.venue} {entry.seatLocation !== "-" && `(${entry.seatLocation})`}</span>
                    </div>
                  </div>
                </div>
